              ...
              <table class="table table-bordered table-hover table-striped">
                ...
                <?php
                 ...
                 ?>
                  ...
                  <td><a href="<?php echo BASE_URL;?>/index.php?page=org&m=edit&id=<?php echo $user->get_user_id();?>" class="btn btn-primary btn-sm glyphicon glyphicon-pencil"></a> 
                      <a href="<?php echo BASE_URL;?>/index.php?page=org&m=delete&id=<?php echo $user->get_user_id();?>" class="btn btn-danger btn-sm glyphicon glyphicon-trash" onclick="return confirm('Are you sure?')"></a></td>
                </tr>
