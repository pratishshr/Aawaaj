      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date("Y");?> <a href="">Aawaaj.com</a>.</strong> All rights reserved.
      </footer>
    ...
    <!-- SlimScroll -->
    <script src="<?php echo BASE_URL?>admin/assets/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript"></script>
    <!-- FastClick -->
    <script src="<?php echo BASE_URL?>admin/assets/plugins/fastclick/fastclick.min.js" type="text/javascript"></script>
    <!-- AdminLTE App -->
