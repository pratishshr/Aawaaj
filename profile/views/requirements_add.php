                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            ...
                            <form class="black-color" action="<?php echo BASE_URL.'profile/index.php?id='.$_SESSION['user_hash'].'&page=requirements&m=save';?>" method="POST" enctype="multipart/form-data">
                             <div class="form-group">
                                    ...
                                    <div class="form-group" id="single_date_div">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="details" id="details" rows="10" placeholder="Add detail description of your requirement"></textarea>
                                    </div>  
