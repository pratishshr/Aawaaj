                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            ...
                            <form class="black-color" action="<?php echo BASE_URL.'profile/index.php?id='.$_SESSION['user_hash'].'&page=projects&m=save';?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="requirement1">Requirements (upto 5):</label> <a href="" class="btn btn-success btn-sm" id="btn_plus"><span class="fa fa-plus"></span></a> <a href="" class="btn btn-danger btn-sm" id="btn_minus"><span class="fa fa-minus"></span></a>
